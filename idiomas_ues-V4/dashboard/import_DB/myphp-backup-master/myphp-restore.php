...
define("DB_USER", 'root');
define("DB_PASSWORD", '');
define("DB_NAME", 'uesdb');
define("DB_HOST", 'localhost');
define("BACKUP_DIR", 'BACKUP-ues'); // Comment this line to use same script's directory ('.')
define("BACKUP_FILE", 'myphp-backup-uesdb-20180517_183155.sql.gz'); // Script will autodetect if backup file is gzipped based on .gz extension
define("CHARSET", 'utf8');
